...
//        }
    ...
    private void drawInstructions(Canvas canvas) {
        ...
        paint.setTextAlign(Paint.Align.LEFT);
        int textShiftY = centerText() * 2;
        canvas.drawText("第"+getDate()+"天，"+"一直走下去",
    ...
    private int[] getCellRectangleIds() {
        ...
        cellRectangleIds[1] = R.drawable.item_2;
        cellRectangleIds[2] = R.drawable.item_4;
        cellRectangleIds[3] = R.drawable.item_8;
        cellRectangleIds[4] = R.drawable.item_16;
        cellRectangleIds[5] = R.drawable.item_32;
        cellRectangleIds[6] = R.drawable.item_64;
        cellRectangleIds[7] = R.drawable.item_128;
        cellRectangleIds[8] = R.drawable.item_256;
        cellRectangleIds[9] = R.drawable.item_512;
        cellRectangleIds[10] = R.drawable.item_1024;
        cellRectangleIds[11] = R.drawable.item_2048;
        for (int xx = 12; xx < cellRectangleIds.length; xx++) {
            cellRectangleIds[xx] = R.drawable.item_4096;
        }
